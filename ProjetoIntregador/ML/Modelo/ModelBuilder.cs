...
namespace ProjetoIntregador.ML.Modelo
{
    public class ModelBuilder
    {
        ...
        private IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTreeTweedie(labelColumnName: "Label", featureColumnName: "Features", minimumExampleCountPerLeaf: 5, learningRate: 0.1, numberOfTrees: 500);
